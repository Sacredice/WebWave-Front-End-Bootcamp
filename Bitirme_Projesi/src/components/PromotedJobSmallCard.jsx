...
function PromotedJobSmallCard({ link, imgSrc, job, company, location }) {
  return (
    <div className='container px-0' style={{ border: "1px solid #e4e4e4", borderRadius: "4px", maxWidth: "540px", width: "100%", marginRight: "22px", marginBottom: "16px", maxHeight: "110px" }}>
