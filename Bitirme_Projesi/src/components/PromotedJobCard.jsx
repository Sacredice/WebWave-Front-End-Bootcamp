...
function PromotedJobCard({ link, imgSrc, job, company, location }) {
  return (
    <div className='container px-0' style={{ border: "1px solid #e4e4e4", borderRadius: "4px", maxWidth: "540px", width: "100%", marginRight: "22px", marginBottom: "16px" }}>
        <a className='px-0' href={link} style={{ textDecoration: "none"}}>
            <div className='d-flex align-items-start' style={{ padding: "16px" }}>
                ...
                <div style={{ marginLeft: "8px", paddingRight: "8px"}} >
                    <p style={{ color: "#333",marginBottom: "9px", textWrap: "nowrap" }}>{job}</p>
...
export default PromotedJobCard
